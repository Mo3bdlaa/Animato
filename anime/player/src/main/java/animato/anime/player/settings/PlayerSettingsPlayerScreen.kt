...
object PlayerSettingsPlayerScreen : SearchableSettings {
    ...
    override fun getPreferences(): List<Preference> {
        ...
        // Aniyomi asked Mihon's BasePreferences, which has no such preference — this is a device
        // capability, not a setting, and it is answered by the package manager.
