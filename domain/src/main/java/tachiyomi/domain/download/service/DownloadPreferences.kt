...
/**
 * Download preferences shared by both halves of the app, plus the manga-specific ones.
 *
 * Anime-only preferences live in AnimeDownloadPreferences, over in :anime:domain.
 */
